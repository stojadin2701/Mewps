...
#ifndef SYSTEM_PERIPHERALS_COMM_PROTOCOL_THREADSAFE_H_
#define SYSTEM_PERIPHERALS_COMM_PROTOCOL_THREADSAFE_H_
...
#endif /* SYSTEM_PERIPHERALS_COMM_PROTOCOL_THREADSAFE_H_ */
